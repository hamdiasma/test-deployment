          ...
          <ul className="menu1">
            ...
            <li>
              <Link to="/DashboardE/Femme">
                ...
                <span> Ajouter Article pour Femme</span>
              </Link>
            </li>
            <li>
              <Link to="/DashboardE/Homme">
                ...
                <span> Ajouter Article pour Homme</span>
              </Link>
            </li>
            ...
            <li>
              <Link to="/DashboardE/Enfant">
                ...
                <span> Ajouter Article pour Enfant</span>
              </Link>
            </li>
            <li>
              <Link to="/DashboardE/all/tshirt">
                ...
                <span>Afficher Tous les T-SHIRT</span>
              </Link>
            </li>
            <li>
              <Link to="/DashboardE/all/shoes">
                ...
                <span>Afficher Tous les CHAUSSURES</span>
              </Link>
            </li>
            <li>
              <Link to="/DashboardE/all/jeans">
                ...
                <span>Afficher Tous les JEANS</span>
              </Link>
            </li>
